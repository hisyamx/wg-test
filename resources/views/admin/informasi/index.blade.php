...
<div class="flex flex-col px-4 py-4 mt-8 space-y-4 bg-white rounded-2xl lg:px-8 lg:py-6 lg:flex-row lg:space-y-0 lg:space-x-12">
    <div>
    ...
    <nav class="space-y-2 md:flex md:space-x-4 md:space-y-0">
        ...
        {{-- <a href="{{route('admin.informasi.draft')}}"
            class="inline-flex flex-col items-center justify-center w-auto px-3 py-3 border border-blue-100 rounded-xl hover:bg-blue-50">
...
<div class="px-4 py-4 mt-8 bg-white rounded-2xl lg:px-8 lg:py-6">
    <h2 class="mb-4 text-xl font-bold text-glue-900 lg:mb-6">Daftar Informasi di Upload</h2>
            ...
            <table class="min-w-full">
                <thead class="text-left bg-blue-50">
                    <tr>
                        ...
                        <th class="px-3 py-2">Tanggal Post</th>
                ...
                <tbody class="text-glue-900 divide-y divide-blue-100 text-opacity-80">
                    <tr>
                        ...
                        <td class="px-3 py-3">{{ $item->file }}</td>
                        <td class="px-3 py-3">{{ $item->tanggal_post != null ? $item->tanggal_post->isoFormat('D MMMM Y') : '' }}</td>
                        <td class="px-3 py-3">
                            ...
                            class="inline-flex flex-col items-center justify-center w-12 px-3 py-3 hover:bg-blue-50 rounded-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-glue-900" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <td class="px-3 py-3">
                            ...
                            class="inline-flex flex-col items-center justify-center w-12 px-3 py-3 hover:bg-blue-50 rounded-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-glue-900" viewBox="0 0 20 20" fill="currentColor">
